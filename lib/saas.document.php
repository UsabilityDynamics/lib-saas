<?php
/**
 * Usability Dynamics SaaS Library - Document
 *
 * @version 0.1.2
 * @author potanin@UD
...
namespace UsabilityDynamics {
  ...
  if( !class_exists( 'UsabilityDynamics\Document' ) ) {
    ...
    class Document extends SaaS {
       ...
       * @type {Object}
       */
      private static $client = 'UD_Cloud/1.0.2';

      static $defaults = 'saas.config.json';
      static $option = 'ud_cloud';
      static $url = 'http://saas.usabilitydynamics.com';
